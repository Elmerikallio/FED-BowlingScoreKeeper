...
function GameSetup() {
  const { players, addPlayer, matchSize, setMatchSize } =
    useContext(BowlingContext);
...
function ScoreBoard() {
  const { players, scores, updateScore, currentGame, matchSize, resetGame } =
    useContext(BowlingContext);
  ...
  return (
    <div className="scoreboard">
      ...
      {currentGame >= matchSize ? (
        ...
        <button onClick={resetGame} className="next-game">
          Next Game
        </button>
      )}
    </div>
